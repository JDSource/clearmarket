...
related_markets:
  - platform: "kalshi"
    ...
    current_price: 0.6
bullets:
  - "Kalshi prices Arc token launch at 60%, Polymarket at 51%, a 9pp spread."
  - "Kalshi sits higher; Polymarket carries the deeper book by a wide margin."
  - "Thin Kalshi liquidity may allow a small cohort of informed or directional traders to set price; Polymarket's larger pool likely reflects broader consensus."
  - "Resolution hinges on any verifiable Arc token issuance or public launch announcement before Jan 1, 2027."
atomic_claims:
...
The 9pp gap on a shallow-vs-deep liquidity split suggests Kalshi's price is more susceptible to idiosyncratic flow, and desks should weight Polymarket's 51% as the more robust anchor here.
