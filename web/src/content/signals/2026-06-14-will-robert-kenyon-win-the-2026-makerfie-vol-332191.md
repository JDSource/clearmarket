...
bullets:
  - "Polymarket prices Robert Kenyon winning the 2026 Makerfield by-election at 27%, clear underdog."
  - "24h volume of $332K is 47% of all-time; nearly half of all lifetime activity arrived in one session."
  - "Concentrated fresh attention on a UK constituency by-election signals a new poll or campaign development."
  - "At 27%, Kenyon holds real upset probability; resolution tied to by-election date."
atomic_claims:
  - type: "volume_anomaly"
...
A sudden near-halving of all-time volume in a single session on a UK by-election seat signals a catalyst, likely a new poll or endorsement, and warrants a desk check on UK political flow for broader Labour/Reform implications.
