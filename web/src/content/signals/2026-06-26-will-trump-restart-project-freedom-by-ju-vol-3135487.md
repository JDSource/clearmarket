...
bullets:
  - "Polymarket at 100%, market treats June 30 restart as fully resolved certainty."
  - "24h volume $3.1M is 59% of all-time; near-total capital conviction compressed into final days."
  - "Late flow likely arbitrage and settlement positioning as contract approaches expiry June 30."
  - "Resolution imminent; desk attention is on settlement mechanics, not directional risk."
atomic_claims:
  - type: "volume_anomaly"
...
A contract priced at 100% absorbing 59% of its all-time volume in 24 hours signals final-leg arbitrage and settlement squeezing rather than new directional conviction.
