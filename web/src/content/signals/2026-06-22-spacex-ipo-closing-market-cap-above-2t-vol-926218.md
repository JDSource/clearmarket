...
bullets:
  - "Polymarket prices $2T floor at 93%, market has near-fully absorbed downside risk at this level."
  - "24h volume of $926K is the largest single SpaceX strike print, 43% of all-time float."
  - "High price combined with dominant volume suggests late longs compressing remaining cheap tail protection."
  - "Resolves at IPO closing print; a sub-$2T close would be a significant macro repricing event."
atomic_claims:
  - type: "volume_anomaly"
...
This is the anchor contract in the SpaceX IPO suite; the volume surge at 93% indicates the market has functionally dismissed a sub-$2T outcome and desks should price hedges accordingly.
