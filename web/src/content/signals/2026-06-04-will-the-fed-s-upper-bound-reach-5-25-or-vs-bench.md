...
headline: "FFR Upper Bound ≥5.25% Before 2027: 3%; at 3.75%"
...
bullets:
  - "Polymarket prices 3% chance the fed funds upper bound reaches 5.25% or higher before 2027."
  - "FRED benchmark: fed funds upper bound currently 3.75%, requiring 150 bps of net hikes."
  - "Market prices near-zero probability of aggressive tightening from current levels."
  - "Resolves if FRED upper bound prints ≥5.25% before Jan 2027."
atomic_claims:
...
Reaching 5.25% from 3.75% would require 150 bps of hikes in roughly six months; at 3%, the market essentially rules this out, which is consistent with the current rate level but worth flagging given the 39% hike-in-2026 probability elsewhere.
