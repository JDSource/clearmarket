...
bullets:
  ...
  - "Kalshi sits higher; Polymarket holds the deeper book with ~8.7x more cumulative volume."
  - "Thin Kalshi liquidity may reflect retail optimism unanchored by larger informed flow on Polymarket."
...
The 9pp spread, set against a lopsided liquidity ratio, suggests Kalshi's higher print is noise-driven rather than an informed premium, desks should weight the deeper Polymarket figure.
