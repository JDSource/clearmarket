...
bullets:
  - "Polymarket at 67%, majority of capital expects closing cap to clear $2.2T threshold."
  - "24h volume $722K is 56% of all-time; pricing discovery around this strike is accelerating."
  - "Part of a multi-strike cluster; $2.2T is the key contested level where confidence breaks from near-certainty."
  - "Resolution tied to SpaceX IPO closing print, making this the marginal-price discovery contract."
atomic_claims:
  - type: "volume_anomaly"
...
The $2.2T strike at 67% versus $2T at 93% reveals the market's modal IPO valuation range and shows traders are actively pricing the distribution's upper tail.
