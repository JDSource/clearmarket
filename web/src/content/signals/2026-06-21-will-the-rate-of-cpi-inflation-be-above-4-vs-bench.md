---
signal_id: "CMSIG20260621BD01"
signal_slug: "will-the-rate-of-cpi-inflation-be-above-4-vs-bench"
headline: "CPI above 4% June yr: 23%; FRED CPI y/y at 4.3%"
semantic_title: "Capital fades US CPI staying above 4% despite live print"
...
bullets:
  - "Kalshi prices only a 23% chance CPI year-over-year exceeds 4.0% through June 2026."
  - "FRED CPI year-over-year currently stands at 4.3%, already above the threshold."
  - "Market discounts the live reading, implying traders expect a rapid near-term decline."
...
With CPI already printing at 4.3%, a 23% probability implies traders are aggressively fading the current above-threshold read, betting on a swift drop before the June resolution, a striking divergence from the live FRED data the desk should scrutinize.
