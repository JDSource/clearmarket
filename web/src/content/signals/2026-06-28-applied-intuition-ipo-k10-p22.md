...
related_markets:
  - platform: "kalshi"
    ...
    current_price: 0.1
bullets:
  - "Kalshi at 10%, Polymarket at 23%, a 13pp spread on identical before-2027 horizon."
  - "Polymarket is the higher side with roughly 100x the cumulative volume of Kalshi."
  - "Thin Kalshi liquidity likely reflects price discovery lag rather than informed bearish view."
...
With nearly all market volume concentrated on Polymarket's higher price, the Kalshi print should be treated as a stale, low-conviction quote, desks would weight Polymarket's 23% as the more credible anchor.
