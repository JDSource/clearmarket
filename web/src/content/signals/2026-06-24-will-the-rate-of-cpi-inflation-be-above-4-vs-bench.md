---
signal_id: "CMSIG20260624BD01"
signal_slug: "will-the-rate-of-cpi-inflation-be-above-4-vs-bench"
headline: "CPI above 4% year-end June: 23%; FRED at 4.3%"
...
bullets:
  ...
  - "FRED CPI year-over-year currently stands at 4.3%, already above the 4.0% threshold."
  - "Market heavily discounts the live reading, implying traders expect a sharp near-term disinflation."
  - "Resolves against the BLS CPI release for June 2026, due mid-July 2026."
atomic_claims:
...
With CPI already printing at 4.3% year-over-year, Kalshi's 23% probability implies traders are aggressively betting on a rapid drop below 4% in the remaining data, a strong divergence from the current official benchmark.
