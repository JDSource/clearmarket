...
bullets:
  ...
  - "Polymarket logged $139M in 24h, 60% of all-time volume, an extraordinary late conviction flush."
  - "Resolution window has passed; capital floods in to lock near-certain NO outcome at expiry."
  - "Contract resolves NO; volume reflects settlement arbitrage, not speculative repositioning."
atomic_claims:
  - type: "volume_anomaly"
...
The surge is classic post-resolution arb compression, desks should treat this as a closed position, not a live signal.
