...
bullets:
  ...
  - "Kalshi sits higher; cumulative volume heavily skewed to Polymarket ($22K vs $2.5K)."
  - "Thin Kalshi liquidity may reflect fewer informed participants, inflating the yes side."
  - "Resolves on any confirmed Arc token public launch before Jan 1, 2027."
atomic_claims:
...
The 9pp gap on thin Kalshi volume suggests the higher Kalshi price is less reliable, desks should weight Polymarket's 51% as the more liquid anchor on this claim.
