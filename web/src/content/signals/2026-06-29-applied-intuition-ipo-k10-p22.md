...
related_markets:
  - platform: "kalshi"
    ...
    current_price: 0.1
bullets:
  - "Polymarket prices the IPO at 23%, Kalshi at 10%, a 13pp spread on the same before-2027 claim."
  - "Polymarket is the higher side with over 100x Kalshi's cumulative volume, indicating far deeper price discovery."
  - "Kalshi's thin liquidity suggests its 10% may reflect limited informed participation rather than a considered bearish view."
  - "Resolution hinges on a confirmed public listing before Jan 1, 2027, roughly six months of runway remaining."
atomic_claims:
...
With Polymarket carrying nearly all the liquidity, its 23% is the more market-tested price, and the 13pp gap primarily reflects Kalshi's shallow book rather than a genuine analytical disagreement.
