...
bullets:
  - "Polymarket at 67% implies markets lean toward a premium-tier debut above $2.2T."
  - "$722K in 24h is 56% of all-time volume, IPO pricing mechanics drawing concentrated attention."
  - "Spread between $2T (93%) and $2.2T (67%) isolates the contested valuation band."
  - "Resolution tied to IPO closing cap; no date specified, so horizon risk remains open."
atomic_claims:
  - type: "volume_anomaly"
...
The $2.0T, $2.2T valuation band is where informed capital is being deployed, a desk should watch bookbuilding signals and anchor investor allocations for directional confirmation.
