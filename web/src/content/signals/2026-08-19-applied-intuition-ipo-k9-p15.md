...
primary_market:
  ...
  current_price: 0.157
  volume_cumulative_usd: 205886.665985
...
related_markets:
  - platform: "kalshi"
    ...
    current_price: 0.09
bullets:
  - "Polymarket prices the IPO at 16%, Kalshi at 9%, a 7pp gap, with Polymarket nearly double."
  - "Polymarket is higher and holds roughly 95x more cumulative volume than Kalshi on this contract."
  - "Kalshi's thinner pool may under-reflect recent IPO pipeline chatter; Polymarket's depth gives it stronger price-discovery weight."
...
Polymarket's 16% vs Kalshi's 9%, with an overwhelming volume advantage, points to a genuine information gap on the smaller venue, making Kalshi's low print the likely stale side of the trade.
