...
bullets:
  ...
  - "$3.1M traded in 24h, 59% of all-time volume, signals terminal settlement rush."
  - "Late liquidity at full price typically reflects arbitrage harvesting near deadline."
  - "Resolves June 30; any remaining flow is basis risk, not directional."
atomic_claims:
  - type: "volume_anomaly"
...
A desk should treat this as a near-resolved arb trade, not a live directional signal, monitor for any late contract anomaly before the June 30 cutoff.
