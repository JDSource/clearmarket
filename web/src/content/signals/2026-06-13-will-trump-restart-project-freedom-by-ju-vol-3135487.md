...
bullets:
  - "Polymarket prices Project Freedom restart by June 30 at 100%, market treats outcome as resolved."
  - "24h volume of $3.1M is 59% of all-time handle, signaling a decisive terminal flow."
  - "Late-stage capital deployment at ceiling price suggests confirming event or announcement imminent."
  - "Resolves June 30; near-zero residual uncertainty leaves little actionable edge."
atomic_claims:
  - type: "volume_anomaly"
...
A desk should treat this as a near-resolved contract, the volume surge reflects position close-out and confirmation trading, not fresh directional risk.
