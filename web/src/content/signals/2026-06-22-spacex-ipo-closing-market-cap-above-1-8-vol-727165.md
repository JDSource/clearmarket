...
bullets:
  - "Polymarket prices $1.8T IPO floor at 98%, treated as a near-certainty by active capital."
  - "24h volume of $727K equals 40% of all-time, consistent with arbitrage-driven settlement compression."
  - "At 2 cents on the dollar, remaining sellers are absorbing tail risk for yield, not conviction."
  - "Resolves at IPO close; only a catastrophic deal disruption would move this contract."
atomic_claims:
  - type: "volume_anomaly"
...
Desk utility here is limited to basis-trade mechanics, the volume spike reflects arb flow, not directional information about the IPO outcome.
