...
bullets:
  ...
  - "$139M traded in 24h, 60% of all-time volume floods in post-deadline for settlement."
  - "Resolution imminent or passed; capital deploying to lock in near-certain NO payout."
  - "Polymarket contract likely resolving NO; volume reflects last-minute conviction arb."
atomic_claims:
  - type: "volume_anomaly"
...
The extreme volume at 0% signals a resolved or near-resolved contract with traders rushing to capture residual settlement value, monitor for formal Polymarket resolution notice.
