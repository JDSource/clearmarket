...
bullets:
  - "Polymarket prices certainty, 100% implies the contract is effectively resolved."
  - "24h volume of $3.1M is 59% of all-time, signaling a decisive settlement rush."
  - "Sudden finality suggests a triggering event, announcement or official confirmation, landed today."
  - "Contract resolves June 30; near-zero time value collapses remaining two-sided flow."
atomic_claims:
  - type: "volume_anomaly"
...
A desk should treat this as a resolved or near-resolved event and pivot to downstream policy and asset implications rather than further position-taking.
