...
bullets:
  - "Polymarket prices zero probability Bitcoin reaches $100K before June 30, absolute consensus."
  - "$253K in 24h is 85% of all-time volume, signaling the contract is in terminal resolution phase."
  - "With Bitcoin well below $100K as of today, the surge reflects settlement and arb flow, not debate."
  - "Contract resolves NO; volume confirms the level was never tested within the June window."
atomic_claims:
  - type: "volume_anomaly"
...
Eighty-five percent of all-time volume printing at 0% is a mechanical settlement signal, no directional read on Bitcoin itself, but confirms the $100K level remained out of reach for June.
