...
bullets:
  - "Polymarket prices a $2.2T close at 67%, market assigns meaningful but not dominant probability."
  - "56% of all-time volume in 24h points to a live pricing event, likely IPO terms or bookbuild news."
  - "The 67% level marks this as the critical swing threshold in the SpaceX valuation ladder."
  - "Resolves at IPO closing price; outcome determines the $2T, $2.4T band's resolution cascade."
atomic_claims:
  - type: "volume_anomaly"
...
This contract functions as the market's marginal price-discovery node for the SpaceX IPO, the 67% print and heavy all-time volume share indicate desks are actively positioning around the $2.2T level as the key valuation pivot.
