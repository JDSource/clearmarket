...
bullets:
  - "Polymarket at 98%, capital treats the $1.8T threshold as nearly resolved certainty."
  - "$727K in 24h, 40% of all-time volume, suggests arb-finalization rather than fresh direction."
  - "Pricing 5 points below certainty implies residual deal-execution or market-dislocation hedges."
  - "Low-alpha threshold; flow here reflects portfolio hedging, not primary price discovery."
atomic_claims:
  - type: "volume_anomaly"
...
Near-certain pricing with meaningful volume signals institutional desks are hedging tail scenarios, a structural deal collapse or market-wide selloff, rather than taking directional views.
