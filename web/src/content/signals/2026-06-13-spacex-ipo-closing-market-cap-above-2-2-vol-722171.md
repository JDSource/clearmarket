...
bullets:
  - "Polymarket prices SpaceX IPO closing above $2.2T at 67%, majority probability but meaningful tail risk remains."
  - "24h volume of $722K is 56% of all-time, pointing to concentrated fresh positioning around this strike."
  - "The $2.2T level sits as the contested middle ground between the near-certain $2T and fading $2.4T strikes."
  - "Resolution contingent on IPO closing price; this strike defines the market's central valuation anchor."
atomic_claims:
  - type: "volume_anomaly"
...
Heavy cross-strike activity across the SpaceX IPO cap ladder signals institutional desks are building synthetic range positions, the $2.2T contract is the key pivot.
