...
bullets:
  - "Polymarket at 27%, market positions Kenyon as a credible but underdog candidate."
  - "$332K in 24h is 47% of all-time volume, signaling a sharp acceleration in political attention."
  - "Attention clustering ahead of a by-election vote often precedes polling or campaigning news."
  - "Resolution on election day; 27% implies the seat is competitive but not Kenyon's to lose."
atomic_claims:
  - type: "volume_anomaly"
...
A sudden attention spike on a UK constituency by-election at 27% suggests a desk should monitor for new polling data or a late-breaking campaign development that may have triggered the inflow.
