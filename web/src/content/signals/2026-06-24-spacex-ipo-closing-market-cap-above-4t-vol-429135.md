...
bullets:
  - "Zero probability priced, capital deployed here is exclusively on the 'no' side."
  - "48% of all-time volume in 24h reflects curiosity or arbitrage, not genuine $4T conviction."
  - "$4T would nearly double the upper-range SpaceX consensus; the market has closed this debate."
  - "Resolves at IPO close; its 0% reading sets an absolute ceiling in the contract ladder."
atomic_claims:
  - type: "volume_anomaly"
...
The $4T contract's zero price on meaningful volume confirms the market's outer valuation bound; a desk can use this to eliminate extreme upside tail scenarios from any SpaceX IPO distribution model.
