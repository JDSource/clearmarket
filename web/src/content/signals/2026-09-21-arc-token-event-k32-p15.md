...
primary_market:
  ...
  current_price: 0.15
  volume_cumulative_usd: 162952.933094
...
bullets:
  ...
  - "Kalshi sits higher; Polymarket carries the deeper book with over $162K cumulative volume vs under $5K on Kalshi"
  - "Thin Kalshi liquidity likely distorts its price upward; Polymarket's larger pool is the more credible read at ~15%"
  - "Resolves YES if Arc officially launches a token on any network before Jan 1, 2027"
atomic_claims:
  - type: "cross_venue_spread"
    ...
    liquidity_context:
      ...
      poly_vol_24h_usd: 723.2052929999999
sources:
...
The 17pp spread almost certainly reflects Kalshi's shallow book being moved by a handful of trades rather than genuine information, making Polymarket's 15% the more defensible anchor for desks pricing this event.
