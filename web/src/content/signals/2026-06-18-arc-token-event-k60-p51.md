...
bullets:
  ...
  - "Kalshi is the higher-side venue; Polymarket carries roughly 9x the cumulative volume."
  - "Thin Kalshi liquidity may allow a small-cohort consensus to hold an elevated price unsupported by broader flow."
  - "Resolution: any publicly announced Arc token launch constituting a live tradeable asset before Jan 1, 2027."
atomic_claims:
...
The 9pp spread on thin Kalshi volume versus deep Polymarket flow suggests Kalshi's 60% is an illiquid outlier, and the Polymarket 51% is the more crowd-tested reference for a desk pricing Arc token risk.
