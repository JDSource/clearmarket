...
bullets:
  - "Polymarket prices $2.4T market cap at IPO close at just 21%, strong majority against this strike."
  - "24h volume of $696K is 42% of all-time, indicating fresh positioning against the upper-bound scenario."
  - "Spread between 67% at $2.2T and 21% at $2.4T implies the market concentrates fair value in the $2.0T, $2.3T band."
  - "Resolves at IPO close; a blowout debut above $2.4T remains a low-probability but non-trivial tail."
atomic_claims:
  - type: "volume_anomaly"
...
A desk reading the full SpaceX strike curve should note that the $2.4T contract anchors the upper tail, fresh selling here confirms consensus fair value is well below this level.
