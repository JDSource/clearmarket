...
bullets:
  ...
  - "Polymarket is the higher side with substantially greater cumulative volume than Kalshi."
  - "Polymarket's deeper liquidity and defense/autonomy-sector audience may embed sharper deal intelligence."
  - "Resolves YES on completion of a public listing or direct listing before Jan 1, 2027."
atomic_claims:
...
With Polymarket holding the higher price and the deeper book, the 8pp gap suggests Kalshi's crowd is underweighting Applied Intuition's IPO probability, desks should treat Polymarket's 18% as the better-informed signal.
