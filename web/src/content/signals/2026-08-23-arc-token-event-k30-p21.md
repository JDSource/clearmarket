---
signal_id: "CMSIG20260823DV00"
signal_slug: "arc-token-event-k30-p21"
headline: "Arc token launch before Jan 1 2027: Kalshi 30% vs Polymarket 21%"
semantic_title: "Arc token-before-2027 odds split sharply across venues"
telemetry: "Polymarket 21% vs Kalshi 30%"
...
primary_market:
  ...
  current_price: 0.21
  volume_cumulative_usd: 151308.70787799996
...
related_markets:
  - platform: "kalshi"
    ...
    current_price: 0.3
bullets:
  - "Kalshi prices Arc token launch at 30%, Polymarket at 21%, a 9pp gap on the same claim."
  - "Kalshi sits higher; liquidity heavily skewed toward Polymarket ($151K cumulative vs $3K)."
  - "Thin Kalshi volume likely inflates its price; Polymarket's deeper book is the more credible signal."
...
atomic_claims:
  - type: "cross_venue_spread"
    ...
    liquidity_context:
      kalshi_vol_24h_usd: 106.36
      poly_vol_24h_usd: 729.99
sources:
...
The 9pp gap almost certainly reflects a thin, unanchored Kalshi market rather than genuine belief divergence, a desk should weight the Polymarket price and treat Kalshi as noise until volume builds.
