...
bullets:
  - "21% on Polymarket places $2.4T firmly in tail-risk territory, the market is selling into optimism."
  - "$696K in 24h represents 42% of all-time, with capital concentrated on the short side of this threshold."
  - "Combined with 67% at $2.2T, the market implies a tight central range and steep drop-off above $2.2T."
  - "Any anchor order leak or revised bookrunner guidance above $2.3T would reprice this sharply."
atomic_claims:
  - type: "volume_anomaly"
...
The $2.4T contract is the market's short leg in the SpaceX valuation cluster; a desk can monetize the spread between $2.2T and $2.4T as the core uncertainty band.
