...
bullets:
  - "Market prices zero probability MicroStrategy liquidated any BTC through May 31 deadline."
  - "Polymarket logged $139M in 24h volume, 60% of all-time handle, a historic conviction flush."
  - "Surge likely reflects final settlement rush as contract approaches or hits resolution."
  - "Contract resolves NO; capital absorbed at near-zero, confirming market consensus was never shaken."
atomic_claims:
  - type: "volume_anomaly"
...
The extraordinary volume concentration at 0% signals institutional desks treating this as a resolved certainty, not a live risk, final settlement positioning rather than fresh price discovery.
