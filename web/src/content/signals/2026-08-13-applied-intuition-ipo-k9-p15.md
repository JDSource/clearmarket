...
related_markets:
  - platform: "kalshi"
    ...
    current_price: 0.09
bullets:
  - "Polymarket prices the IPO at 16%, Kalshi at 9%, a 7pp gap with Polymarket the higher venue."
  - "Polymarket leads on liquidity ($205K vs $2.2K), giving its price substantially more weight."
  - "Kalshi's thin volume makes its 9% read unreliable; Polymarket's deeper market is the stronger reference."
  - "Resolves YES only on a completed public listing before Jan 1, 2027."
atomic_claims:
...
With Kalshi volume nearly negligible, the 7pp gap is best read as a Kalshi pricing artifact, a desk should anchor to Polymarket's 16% until Kalshi liquidity builds.
