---
signal_id: "CMSIG20260712BD01"
signal_slug: "will-the-rate-of-cpi-inflation-be-above-3-vs-bench"
headline: "CPI above 3.8%: 24%; actual CPI at 4.2%"
...
published_at: "2026-07-12T09:49:21+00:00"
...
primary_market:
  ...
  current_price: 0.24
  volume_cumulative_usd: 44219.98
  resolves_at: "2026-10-13T14:00:00Z"
bullets:
  - "Kalshi prices only 24% odds that CPI exceeds 3.8% for the year ending June 2026."
  - "FRED CPI year-over-year currently sits at 4.2%, already above the 3.8% threshold."
  - "Market implies near-certainty inflation will fall back below 3.8%, despite the live print clearing it."
  - "Resolves against the BLS June 2026 CPI release."
atomic_claims:
  - type: "benchmark_divergence"
    ...
    field_provenance:
      ...
      benchmark_value:
        ...
        retrieved_at: "2026-07-12T09:49:21+00:00"
sources:
...
With CPI already printing at 4.2%, traders pricing only 24% for a above-3.8% outcome implies an aggressive expectation of rapid disinflation that the current data does not support.
