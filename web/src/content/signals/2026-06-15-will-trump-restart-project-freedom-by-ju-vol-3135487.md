---
signal_id: "CMSIG20260615VS00"
signal_slug: "will-trump-restart-project-freedom-by-ju-vol-3135487"
headline: "Project Freedom restart: 100% with $3.1M surge"
...
bullets:
  - "Polymarket prices certainty at 100%, market treats June 30 restart as fait accompli."
  - "24h volume $3.1M is 59% of all-time float, signaling a decisive terminal settlement rush."
  - "Surge likely driven by a confirmatory official action or announcement within the past 24h."
  - "Resolves June 30; near-certain resolution makes this a yield-harvesting flow, not discovery."
atomic_claims:
  - type: "volume_anomaly"
...
A 100% price on 59% of all-time volume in a single session signals this contract is in terminal resolution mode, desks should treat remaining activity as arbitrage harvesting, not directional positioning.
