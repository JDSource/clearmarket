...
related_markets:
  - platform: "kalshi"
    ...
    current_price: 0.11
bullets:
  - "Polymarket sits at 18%, Kalshi at 11% for an Applied Intuition IPO before 2027, an 8pp gap."
  - "Polymarket is the higher-priced venue and commands substantially greater contract liquidity than Kalshi."
  - "Polymarket's defense-tech and autonomous-vehicle trader base may be more attuned to Applied Intuition's fundraising cadence."
  - "Contract resolves YES on a completed public offering or equivalent liquidity event before January 1, 2027."
atomic_claims:
...
The 8pp dislocation on very thin Kalshi volume makes Polymarket's 18% the actionable anchor, though the spread is wide enough to warrant monitoring if Kalshi depth builds.
