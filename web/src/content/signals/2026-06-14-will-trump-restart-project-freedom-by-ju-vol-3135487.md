...
bullets:
  - "Polymarket prices Project Freedom restart at 100%, market treats outcome as fully resolved."
  - "24h volume of $3.1M is 59% of all-time; dominant single-session conviction flush."
  - "Near-total certainty implies confirming news or official announcement already in circulation."
  - "Resolves June 30; at 100% remaining volume is pure arbitrage and position unwinding."
atomic_claims:
  - type: "volume_anomaly"
...
A desk should treat this as a resolved or near-resolved event, the capital flow is settlement-driven, not speculative, and warrants immediate news confirmation.
