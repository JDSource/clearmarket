...
bullets:
  - "Polymarket prices zero probability MicroStrategy liquidated any BTC before May 31 deadline."
  - "$139M traded in 24h, 60% of all-time volume, extraordinary terminal conviction on a resolved outcome."
  - "Volume surge likely reflects settlement/arbitrage activity as contract approaches or has passed resolution."
  - "Contract resolves NO; capital flowing in confirms the market has fully closed the question."
atomic_claims:
  - type: "volume_anomaly"
...
The flood of capital at 0% signals a resolved or near-resolved contract being arbed to zero, desks should treat this as settlement flow, not fresh directional conviction.
