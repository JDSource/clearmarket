...
bullets:
  ...
  - "Kalshi is the higher side; Polymarket carries significantly deeper liquidity on the contract."
  - "Thin Kalshi volume may reflect fewer, more conviction-driven participants skewing the print higher."
...
The 9pp gap on a sub-seven-month horizon suggests Kalshi's shallow book is being moved by a small number of informed or speculative participants, while Polymarket's larger crowd prices the event as a coin-flip lean toward No, a desk should weight the deeper-liquidity venue as the more reliable signal.
