...
bullets:
  - "Polymarket assigns zero probability Bitcoin reaches $100K before June 30."
  - "$253K 24h volume is 85% of all-time; almost entire contract history printed today."
  - "BTC currently trading well below $100K threshold with weeks remaining in June."
  - "Contract resolves June 30; market effectively declaring target unreachable."
atomic_claims:
  - type: "volume_anomaly"
...
Near-total all-time volume printing at zero probability signals traders closing out or bottom-ticking a definitively failed upside target for June.
