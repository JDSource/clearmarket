...
bullets:
  ...
  - "FRED benchmark: CPI year-over-year currently at 3.9%."
  - "Market implies near-certainty of inflation breaching the surge threshold, with CPI already elevated."
  - "Resolution criteria tied to official CPI benchmark during 2026."
atomic_claims:
...
Kalshi's 97% 'inflation surge' probability sits alongside a CPI already at 3.9%, suggesting the market is pricing in near-inevitable further acceleration rather than any reversion, with very little probability mass on inflation cooling.
