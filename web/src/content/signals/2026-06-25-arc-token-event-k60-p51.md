---
signal_id: "CMSIG20260625DV00"
signal_slug: "arc-token-event-k60-p51"
headline: "Arc token before 2027: Kalshi 60% vs Polymarket 51%"
...
related_markets:
  - platform: "kalshi"
    ...
    current_price: 0.6
bullets:
  - "Kalshi prices Arc token launch at 60%, Polymarket at 51%, a 9pp gap."
  - "Kalshi is the higher venue; Polymarket carries roughly 9x the cumulative volume."
  - "Thin Kalshi liquidity may allow a small cohort of informed or speculative traders to skew the price; Polymarket's deeper market likely reflects broader consensus."
  - "Resolves YES if Arc publicly launches a token before Jan 1, 2027; definition of 'launch' may itself drive disagreement."
atomic_claims:
...
The 9pp spread on a shallow Kalshi book versus a much deeper Polymarket pool suggests the Kalshi price is noise-sensitive and the Polymarket figure is the more defensible anchor for a desk sizing a position.
