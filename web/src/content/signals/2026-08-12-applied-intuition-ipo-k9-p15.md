---
signal_id: "CMSIG20260812DV01"
signal_slug: "applied-intuition-ipo-k9-p15"
headline: "Applied Intuition IPO before 2027? Kalshi 9% vs Polymarket 16%"
semantic_title: "Applied Intuition IPO odds run in opposite directions across venues"
...
related_markets:
  - platform: "kalshi"
    ...
    current_price: 0.09
bullets:
  - "Polymarket prices the IPO at 16%, Kalshi at 9%, a 7pp gap on a low-probability claim"
  - "Polymarket is the higher venue and holds roughly 95x the cumulative volume"
  - "At single-digit vs low-teen probabilities, a 7pp gap is proportionally large; Polymarket's depth lends it more credibility"
  - "Resolves YES only on a completed Applied Intuition public offering before Jan 1, 2027"
atomic_claims:
...
With less than five months to resolution and Kalshi's volume negligible, the 7pp gap likely reflects Kalshi's illiquidity rather than a genuine information difference, Polymarket's 16% is the more actionable reference.
