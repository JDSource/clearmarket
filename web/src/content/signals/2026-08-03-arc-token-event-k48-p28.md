---
signal_id: "CMSIG20260803DV00"
signal_slug: "arc-token-event-k48-p28"
headline: "Arc token before 2027: Kalshi 48% vs Polymarket 28%"
semantic_title: "Arc token launch odds split sharply across venues"
telemetry: "Polymarket 28% vs Kalshi 48%"
...
primary_market:
  ...
  current_price: 0.28
  volume_cumulative_usd: 129832.45992100002
...
related_markets:
  - platform: "kalshi"
    ...
    current_price: 0.48
bullets:
  - "Kalshi prices Arc token launch at 48%, Polymarket at 28%, a 20pp gap."
  - "Kalshi sits higher with $3,333 cumulative volume; Polymarket holds lower at $129,832 volume."
  - "Polymarket's deeper liquidity likely reflects better-informed consensus; Kalshi's thin book may overstate launch probability."
...
atomic_claims:
  - type: "cross_venue_spread"
    ...
    liquidity_context:
      kalshi_vol_24h_usd: 101.21
      poly_vol_24h_usd: 1223.35044
sources:
...
The 20pp spread on thin Kalshi volume against a deep Polymarket book suggests Polymarket's 28% is the more credible reference price for a desk weighing this claim.
