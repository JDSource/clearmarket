---
signal_id: "CMSIG20260724DV00"
signal_slug: "arc-token-event-k60-p40"
headline: "Arc token launch before 2027: Kalshi 60% vs Polymarket 40%"
semantic_title: "Arc token launch odds split sharply across venues"
telemetry: "Polymarket 40% vs Kalshi 60%"
...
primary_market:
  ...
  current_price: 0.4
  volume_cumulative_usd: 89187.51116400007
...
related_markets:
  - platform: "kalshi"
    ...
    current_price: 0.6
bullets:
  - "Kalshi prices Arc token launch at 60%, Polymarket at 40%, a 20pp gap"
  - "Kalshi is the higher venue; liquidity thin at $3,501 vs Polymarket's $89,188"
  - "Shallow Kalshi volume likely reflects a small, bullish base with little opposing flow; Polymarket's deeper book is more price-discovered"
...
atomic_claims:
  - type: "cross_venue_spread"
    ...
    liquidity_context:
      kalshi_vol_24h_usd: 28.29
      poly_vol_24h_usd: 130.09
sources:
...
The 20pp spread on razor-thin Kalshi volume signals the higher price is unreliable, Polymarket's 40%, backed by 25x more liquidity, is the more credible anchor for a desk pricing this event.
