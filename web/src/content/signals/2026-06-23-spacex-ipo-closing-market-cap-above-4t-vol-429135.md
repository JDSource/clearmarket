...
bullets:
  - "Polymarket at 0%, capital has entirely written off a $4T closing valuation at IPO."
  - "48% of all-time volume in one session; spike suggests a catalyst definitively closed this scenario."
  - "At nearly double the consensus range ceiling, $4T would require unprecedented IPO demand."
  - "Volume here is likely final settlement activity as the market converges toward NO resolution."
atomic_claims:
  - type: "volume_anomaly"
...
Zero pricing with near-half all-time volume in a single day signals the $4T scenario has been definitively dismissed, useful as a ceiling anchor when modeling the SpaceX valuation distribution.
