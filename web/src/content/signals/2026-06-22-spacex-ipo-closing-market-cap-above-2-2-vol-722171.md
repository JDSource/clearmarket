...
bullets:
  - "Polymarket prices SpaceX IPO closing market cap above $2.2T at 67%, majority probability, meaningful residual risk."
  - "24h volume of $722K represents 56% of all-time, suggesting fresh institutional-adjacent attention at this strike."
  - "Cluster of active SpaceX IPO strikes implies price discovery is live across the $1.8T, $2.4T range."
  - "Resolves at IPO close; positioning here is the swing point between the 93% ($2T) and 21% ($2.4T) brackets."
atomic_claims:
  - type: "volume_anomaly"
...
The $2.2T strike is the fulcrum of the SpaceX IPO cap curve, a desk running a book across strikes should weight this contract as the key risk-transfer node.
