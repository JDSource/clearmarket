...
bullets:
  ...
  - "24h volume of $3.1M is 59% of all-time flow, signaling a terminal settlement rush."
  - "Late-cycle volume at full conviction typically precedes or follows official confirmation."
  - "Contract resolves June 30; capital deployment consistent with known outcome arbitrage."
atomic_claims:
  - type: "volume_anomaly"
...
A desk should treat this as a near-certain resolution event, the volume surge at 100% is consistent with participants closing positions ahead of confirmed settlement, not speculative entry.
