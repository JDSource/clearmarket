...
bullets:
  - "Polymarket prices certainty, 100% implies resolution is effectively confirmed."
  - "24h volume of $3.1M is 59% of all-time; near-total liquidity drawn in one session."
  - "Surge likely driven by an official announcement or executive action treating settlement as imminent."
  - "Resolves by June 30; traders appear to be collecting near-certain yield, not taking directional risk."
atomic_claims:
  - type: "volume_anomaly"
...
A desk should treat this as a resolved or near-resolved event, the volume and 100% price together signal participants are arbitraging a certainty, not expressing a view.
