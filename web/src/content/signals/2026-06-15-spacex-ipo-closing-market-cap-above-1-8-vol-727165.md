...
bullets:
  - "Polymarket prices 98%, $1.8T is effectively the market's hard downside floor for the IPO."
  - "24h volume $727K is 40% of all-time; activity here is yield capture, not valuation debate."
  - "Near-zero residual uncertainty suggests any sub-$1.8T outcome is treated as tail risk only."
  - "Resolves at IPO closing market cap; remaining 2% likely reflects pure liquidity friction."
atomic_claims:
  - type: "volume_anomaly"
...
At 98% with 40% of all-time volume in one session, this contract is functioning as a settlement arb, desks can use the $1.8T strike as a confirmed probability floor when stress-testing SpaceX valuation scenarios.
