---
signal_id: "CMSIG20260819DV00"
signal_slug: "arc-token-event-k39-p26"
headline: "Arc token before 2027: Kalshi 39% vs Polymarket 26%"
...
primary_market:
  ...
  current_price: 0.26
  volume_cumulative_usd: 148975.57121400003
...
related_markets:
  - platform: "kalshi"
    ...
    current_price: 0.39
bullets:
  - "Kalshi prices Arc token launch at 39%, Polymarket at 26%, a 13pp gap."
  - "Kalshi sits higher; Polymarket carries roughly 39x more cumulative volume behind the lower price."
  - "Thin Kalshi liquidity may reflect a smaller, less-informed pool; Polymarket's deeper market likely the more credible signal."
...
atomic_claims:
  - type: "cross_venue_spread"
    ...
    liquidity_context:
      kalshi_vol_24h_usd: 40.27
      poly_vol_24h_usd: 180.479188
sources:
...
The 13pp spread with lopsided volume suggests Kalshi's higher print is a thin-market artifact, a desk leaning on this claim should weight Polymarket's 26% as the more liquid anchor.
