...
bullets:
  - "Polymarket prices $1.8T at 98%, effectively a risk-free base, with 2% tail kept for catastrophic IPO failure."
  - "40% of all-time volume in 24h suggests this is being used as a hedged anchor leg in multi-contract strategies."
  - "The near-certainty price implies traders are layering this contract against higher-threshold shorts."
  - "Minimal standalone alpha; value lies in portfolio construction against $2.2T and $2.4T legs."
atomic_claims:
  - type: "volume_anomaly"
...
A desk should interpret $1.8T volume activity as structural hedging rather than directional conviction, traders are using this near-certain leg to offset exposure on the contested upper-band SpaceX contracts.
