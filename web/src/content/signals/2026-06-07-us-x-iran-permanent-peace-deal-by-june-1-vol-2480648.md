...
bullets:
  - "14% implies residual but non-trivial probability of a formal permanent agreement within days."
  - "24h volume $2.5M represents 28% of all-time, signaling fresh attention not routine churn."
  - "Diplomatic back-channel reports and June 15 deadline proximity are drawing speculative positioning."
  - "Contract resolves June 15; any leaked framework or breakdown will reprice sharply."
atomic_claims:
  - type: "volume_anomaly"
...
A desk should treat the 14% print and 28% all-time volume share as a signal that informed geopolitical money sees a non-negligible near-term path to a deal, warranting a cross-check against oil, rates, and Middle East risk positions.
